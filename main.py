...
resultsdir = 'results/trial_UperNet_kittiCamVid'
...
dataset = getDataset(datapath=[CamViddatapath], dataset='CamVid', data_augment=False, gt_present=True, mode='train', resizex=resizex, resizey=resizey)
...
#model = UperNet(kittiCamViddataset.num_classes, in_channels=3, backbone='swinv1_7_224', pretrained=True, use_aux=True, fpn_out=96, freeze_bn=False, head_out=96, backbonepath='swin_tiny_patch4_window7_224.pth')

model = UperNet(dataset.num_classes, in_channels=3, backbone='swinv1_7_224', pretrained=True, use_aux=True, fpn_out=96, freeze_bn=False, head_out=96, backbonepath='swin_tiny_patch4_window7_224.pth')
...
#data_loader = DataLoader(kittiCamViddataset, batch_size=batch_size, shuffle=True, pin_memory=True, drop_last=True)
